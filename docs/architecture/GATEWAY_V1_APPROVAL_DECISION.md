...
missing/duplicate session-secret headers, invalid route id, or missing/mismatched
independent session proof fail closed. Unsupported methods retain `405` with
